...
const ResearchAndService = () => {
  ...
  return (
    <>
      ...
      <section id="Service" className="bg-white dark:bg-stone-950 text-stone-800 dark:text-stone-100 py-20 px-6 md:px-10 lg:px-20">
        <div className="max-w-6xl mx-auto">
          <div className="mb-12">
            <h1 data-aos="fade-right" className="font-heading text-3xl md:text-4xl font-semibold text-stone-800 dark:text-stone-100">
              Service & Activities
            </h1>
            <div className="w-16 h-1 bg-amber-600 dark:bg-amber-400 mt-4 rounded-full"></div>
          </div>

          <div data-aos="fade-down" className="border-b border-stone-200 dark:border-stone-700 pb-8">
            <ul className="list-disc list-inside text-stone-700 dark:text-stone-200 space-y-4">
              <li>
                <a href="https://edu4sds.org/" className="text-amber-700 dark:text-amber-400 hover:underline font-semibold" aria-label="Visit the Surgical Data Science Summer School website">
              ...
              <li>
                Co-organizer of the{' '}
                <a href="https://dsai.icube.unistra.fr/index.php/Deep_Learning_Tutorial_2019" target="_blank" rel="noopener noreferrer" className="text-amber-700 dark:text-amber-400 hover:underline" aria-label="Visit the DSAI workshop 2021 website">
                  DSAI workshop 2021
                </a>.
              </li>
              <li>
                Part of the local organizing team of the {' '}
                <a href="https://miccai2021.org/en/OUR-VISION.html" target="_blank" rel="noopener noreferrer" className="text-amber-700 dark:text-amber-400 hover:underline" aria-label="MICCAI 2021 website">
